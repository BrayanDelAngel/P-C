   ...
   <div id="top"><!-- Top Begin -->
       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="col-md-6 offer"><!-- col-md-6 offer Begin -->
               ...
               <a href="checkout.php"> <?php items(); ?> Artículos en su carrito | Precio total: <?php total_price(); ?> </a>
       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="navbar-header"><!-- navbar-header Begin -->
               ...
               <a href="../index.php" class="navbar-brand home"><!-- navbar-brand home Begin -->
                   ...
                   <img src="images/Logo_ServiciosP&C.png" style="width: 100%; height: 100%;" alt="ServiciosP&C Logo" class="hidden-xs">
                   <img src="images/Logo_ServiciosP&C.png" style="width: 100%; height: 100%;" alt="ServiciosP&C Logo Mobile" class="visible-xs">
           ...
           <div class="navbar-collapse collapse" id="navigation"><!-- navbar-collapse collapse Begin -->
               ...
               <a href="../cart.php" class="btn navbar-btn btn-primary right"><!-- btn navbar-btn btn-primary Begin -->
                   ...
                   <span><?php items(); ?> Objetos en tu carro de compras</span>
    ...
    ?>
           ...
           <div class="col-md-9"><!-- col-md-9 Begin -->
               ...
               <div class="box"><!-- box Begin -->
                   ...
                   <h1 align="center"> Porfavor Confirma tu Pago</h1>
                   ...
                   <?php 
                    ...
                    if(isset($_POST['confirm_payment'])){
                        ...
                        if($run_pending_order){
                            ...
                            echo "<script>alert('Gracias por comprar, sus pedidos se completarán dentro de las 24 horas de trabajo.')</script>";
