                       ...
                       <div class="box"><!-- box Begin -->
                           ...
                           <form action="details.php?add_cart=<?php echo $product_id; ?>" class="form-horizontal" method="post"><!-- form-horizontal Begin -->
                               <div class="form-group"><!-- form-group Begin -->
                                   <label for="" class="col-md-5 control-label">Cantidad de Productos</label>
                               ...
                               <div class="form-group"><!-- form-group Begin -->
                                   ...
                                   <div class="col-md-7"><!-- col-md-7 Begin -->
                                       ...
                                       <select name="product_size" class="form-control" required oninput="setCustomValidity('')" oninvalid="setCustomValidity('Debe elegir 1 tamaño para el Producto')"><!-- form-control Begin -->
