...
$db = mysqli_connect("localhost","root","","ecom_store","3308");
...
function add_cart(){
    ...
    if(isset($_GET['add_cart'])){
        ...
        if(mysqli_num_rows($run_check)>0){
            ...
            echo "<script>alert('Este producto ya se ha añadido al carrito.')</script>";
        ...
        if($count==0){
            ...
            echo "
                ...
                <div class='box'>
                    ...
                    <h1> No se ha encontrado ningún producto en estas categorías de productos </h1>
        ...
        if($count==0){
            ...
            echo "
                ...
                <div class='box'>
                    ...
                    <h1> Ningún producto encontrado en esta categoría </h1>
