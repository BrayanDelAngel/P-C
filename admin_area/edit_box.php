    ...
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <ol class="breadcrumb"><!-- breadcrumb begin -->
            <li>
                ...
                <i class="fa fa-dashboard"></i> Panel de control / Editar Caja
                ...
                <form action="" class="form-horizontal" method="post"><!-- form-horizontal begin -->
                    ...
                    <div class="form-group"><!-- form-group begin -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 begin -->
                            ...
                            <input value="Actualizar Caja" name="update_box" type="submit" class="form-control btn btn-primary">
...
<?php  
          ...
          if(isset($_POST['update_box'])){
              ...
              if($run_box){
                  ...
                  echo "<script>alert('Tu caja ha sido actualizada')</script>";
