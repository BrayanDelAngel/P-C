            ...
            <div class="panel-heading"><!-- panel-heading begin -->
                <div class="row"><!-- panel-heading row begin -->
                    ...
                    <div class="col-xs-9 text-right"><!-- col-xs-9 text-right begin -->
                        ...
                        <div> Categorías de Producto </div>
            ...
            <div class="panel-body"><!-- panel-body begin -->
                ...
                <div class="mb-md"><!-- mb-md begin -->
                    <div class="widget-content-expanded"><!-- widget-content-expanded begin -->
                        ...
                        <i class="fa fa-flag"></i> <span> País: </span> <?php echo $admin_country; ?> <br/>
                        <i class="fa fa-envelope"></i> <span> Contacto: </span> <?php echo $admin_contact; ?> <br/>
                    </div><!-- widget-content-expanded finish -->
                    
                    <hr class="dotted short">
                    
                    <h5 class="text-muted"> Sobre mí </h5>
