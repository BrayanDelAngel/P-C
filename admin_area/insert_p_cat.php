    ...
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <ol class="breadcrumb"><!-- breadcrumb begin -->
            <li>
                ...
                <i class="fa fa-dashboard"></i> Panel de control / Insertar Categoría de Producto
            ...
            <div class="panel-body"><!-- panel-body begin -->
                <form action="" class="form-horizontal" method="post"><!-- form-horizontal begin -->
                    <div class="form-group"><!-- form-group begin -->
                        ...
                        Título de la categoría de producto
                    ...
                    <div class="form-group"><!-- form-group begin -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 begin -->
                            ...
                            <input value="Enviar" name="submit" type="submit" class="form-control btn btn-primary">
...
<?php  
          ...
          if(isset($_POST['submit'])){
              ...
              if($run_p_cat){
                  ...
                  echo "<script>alert('Se ha insertado su nueva categoría de producto')</script>";
